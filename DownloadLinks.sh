...
if [ $PassFlag -eq 0 ]; then
    ...
    echo "Please visit following website to download java-ich.jar on browsers"
    ...
    echo "--- curl -# -O http://47.95.206.44:50080/Daily_Build/java-ich.tar.gz"
    echo "To unzip file use the command below"
    echo "--- tar -xzvf java-ich.tar.gz"
fi