...
import static org.ich.common.common.utils.Commons.ASSET_ISSUE_COUNT_LIMIT_MAX;
...
@Slf4j(topic = "DB")
@Component
public class AssetIssueStore extends IchStoreWithRevoking<AssetIssueCapsule> {
