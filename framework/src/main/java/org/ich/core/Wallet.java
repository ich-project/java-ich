...
import static org.ich.common.common.utils.Commons.getAssetIssueStoreFinal;
import static org.ich.common.common.utils.Commons.getExchangeStoreFinal;
import static org.ich.common.common.utils.WalletUtil.isConstant;
...
import static org.ich.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.ich.core.config.Parameter.DatabaseConstants.MARKET_COUNT_LIMIT_MAX;
import static org.ich.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.ich.api.GrpcAPI.AccountNetMessage;
import org.ich.api.GrpcAPI.AccountResourceMessage;
import org.ich.api.GrpcAPI.Address;
import org.ich.api.GrpcAPI.AssetIssueList;
import org.ich.api.GrpcAPI.BlockList;
import org.ich.api.GrpcAPI.BytesMessage;
import org.ich.api.GrpcAPI.DecryptNotes;
import org.ich.api.GrpcAPI.DecryptNotes.NoteTx;
import org.ich.api.GrpcAPI.DecryptNotesTRC20;
import org.ich.api.GrpcAPI.DelegatedResourceList;
import org.ich.api.GrpcAPI.DiversifierMessage;
import org.ich.api.GrpcAPI.ExchangeList;
import org.ich.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.ich.api.GrpcAPI.IncomingViewingKeyMessage;
import org.ich.api.GrpcAPI.NfParameters;
import org.ich.api.GrpcAPI.NfTRC20Parameters;
import org.ich.api.GrpcAPI.Node;
import org.ich.api.GrpcAPI.NodeList;
import org.ich.api.GrpcAPI.NoteParameters;
import org.ich.api.GrpcAPI.NumberMessage;
import org.ich.api.GrpcAPI.PaymentAddressMessage;
import org.ich.api.GrpcAPI.PrivateParameters;
import org.ich.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.ich.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.ich.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
...
import org.ich.api.GrpcAPI.ShieldedAddressInfo;
...
import org.ich.api.GrpcAPI.SpendNote;
...
import org.ich.api.GrpcAPI.TransactionExtention.Builder;
...
import org.ich.common.common.zksnark.IncrementalMerkleVoucherContainer;
import org.ich.common.common.zksnark.JLibrustzcash;
import org.ich.common.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.ich.common.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.ich.common.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.ich.common.common.zksnark.LibrustzcashParam.SpendSigParams;
import org.ich.consensus.ConsensusDelegate;
import org.ich.core.actuator.Actuator;
import org.ich.core.actuator.ActuatorFactory;
import org.ich.core.actuator.VMActuator;
...
import org.ich.core.capsule.CodeCapsule;
...
import org.ich.core.db.BandwidthProcessor;
import org.ich.core.db.BlockIndexStore;
...
import org.ich.core.exception.NonUniqueObjectException;
...
import org.ich.core.store.AccountTraceStore;
import org.ich.core.store.BalanceTraceStore;
import org.ich.core.store.ContractStore;
...
import org.ich.core.zen.ShieldedTRC20ParametersBuilder;
import org.ich.core.zen.ShieldedTRC20ParametersBuilder.ShieldedTRC20ParametersType;
import org.ich.core.zen.ZenTransactionBuilder;
import org.ich.core.zen.address.DiversifierT;
import org.ich.core.zen.address.ExpandedSpendingKey;
import org.ich.core.zen.address.IncomingViewingKey;
import org.ich.core.zen.address.KeyIo;
...
public class Wallet {
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.ich.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.ich.common.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
