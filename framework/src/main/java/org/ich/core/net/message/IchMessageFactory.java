...
import org.ich.common.common.overlay.message.MessageFactory;
 ...
 * msg factory.
 */
public class IchMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public IchMessage create(byte[] data) throws Exception {
  ...
  private IchMessage create(byte type, byte[] packed) throws Exception {
