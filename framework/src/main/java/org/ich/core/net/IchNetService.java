...
import org.ich.core.net.messagehandler.BlockMsgHandler;
import org.ich.core.net.messagehandler.ChainInventoryMsgHandler;
import org.ich.core.net.messagehandler.FetchInvDataMsgHandler;
import org.ich.core.net.messagehandler.InventoryMsgHandler;
import org.ich.core.net.messagehandler.PbftDataSyncHandler;
import org.ich.core.net.messagehandler.SyncBlockChainMsgHandler;
import org.ich.core.net.messagehandler.TransactionsMsgHandler;
import org.ich.core.net.peer.PeerConnection;
import org.ich.core.net.peer.PeerStatusCheck;
...
public class IchNetService {
  ...
  public void start() {
    ...
    logger.info("IchNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("IchNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, IchMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, IchMessage msg, Exception ex) {
    ReasonCode code;
