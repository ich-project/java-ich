...
import org.ich.core.services.ratelimiter.RateLimiterContainer;
import org.ich.core.services.ratelimiter.RuntimeData;
import org.ich.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.ich.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.ich.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.ich.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.ich.core.services.ratelimiter.adapter.IRateLimiter;
import org.ich.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "org.ich.core.services.ratelimiter.adapter.";
