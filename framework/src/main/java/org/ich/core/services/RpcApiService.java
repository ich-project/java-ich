...
import org.ich.api.GrpcAPI.EasyTransferAssetMessage;
import org.ich.api.GrpcAPI.EasyTransferByPrivateMessage;
import org.ich.api.GrpcAPI.EasyTransferMessage;
...
import org.ich.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.ich.api.GrpcAPI.TransactionIdList;
import org.ich.api.GrpcAPI.TransactionInfoList;
import org.ich.api.GrpcAPI.TransactionList;
import org.ich.api.GrpcAPI.TransactionListExtention;
import org.ich.api.GrpcAPI.TransactionSignWeight;
import org.ich.api.GrpcAPI.ViewingKeyMessage;
import org.ich.api.GrpcAPI.WitnessList;
import org.ich.api.MonitorGrpc;
import org.ich.api.WalletExtensionGrpc;
import org.ich.api.WalletGrpc.WalletImplBase;
...
import org.ich.core.metrics.MetricsApiService;
...
public class RpcApiService implements Service {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.ich.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.ich.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletApi extends WalletImplBase {
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.ich.common.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void createShieldedContractParameters(
        ...
        StreamObserver<org.ich.api.GrpcAPI.ShieldedTRC20Parameters> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void scanShieldedTRC20NotesByIvk(
        ...
        StreamObserver<org.ich.api.GrpcAPI.DecryptNotesTRC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void getTriggerInputForShieldedTRC20Contract(
        ...
        io.grpc.stub.StreamObserver<org.ich.api.GrpcAPI.BytesMessage> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
