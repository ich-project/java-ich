package stest.ich.wallet.dailybuild.delaytransaction;
...
public class DelayTransaction004 {
  ...
  public void test1DelayUpdateSetting() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractScenario004_deployErc20IchToken");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractScenario004_deployErc20IchToken");
