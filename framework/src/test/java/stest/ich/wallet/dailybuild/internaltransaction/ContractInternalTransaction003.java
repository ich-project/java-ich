package stest.ich.wallet.dailybuild.internaltransaction;
...
import stest.ich.wallet.common.client.utils.Retry;
...
public class ContractInternalTransaction003 {
  ...
  public void dupInternalTrsansactionHash(
      List<org.ich.core.Protocol.InternalTransaction> internalTransactionList) {
