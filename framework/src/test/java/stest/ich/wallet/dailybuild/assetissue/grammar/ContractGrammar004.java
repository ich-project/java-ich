package stest.ich.wallet.dailybuild.assetissue.grammar;

import static org.ich.core.Protocol.Transaction.Result.contractResult.BAD_JUMP_DESTINATION_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.ILLEGAL_OPERATION_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.OUT_OF_MEMORY_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.OUT_OF_TIME_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.REVERT_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.ich.core.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
