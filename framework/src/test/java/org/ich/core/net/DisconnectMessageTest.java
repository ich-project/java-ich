...
import org.ich.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends com.google.protobuf.GeneratedMessageV3 implements
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.ich.protos.Protocol.ReasonCode getReason() {
    org.ich.protos.Protocol.ReasonCode result = org.ich.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.ich.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.ich.protos.Protocol.ReasonCode getName() {
    org.ich.protos.Protocol.ReasonCode result = org.ich.protos.Protocol.ReasonCode.valueOf(name_);
    return result == null ? org.ich.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (reason_ != org.ich.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.ich.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
