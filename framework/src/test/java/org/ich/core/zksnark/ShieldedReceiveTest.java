...
import org.ich.common.common.zksnark.LibrustzcashParam.CheckSpendParams;
...
import org.ich.core.actuator.ActuatorCreator;
...
import org.ich.core.capsule.ReceiveDescriptionCapsule;
...
import org.ich.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static byte[] randomUint256() {
    return org.ich.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.ich.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.ich.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.ich.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.ich.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.ich.keystore.Wallet.generateRandomBytes(1024);
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.ich.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.ich.keystore.Wallet.generateRandomBytes(512);
    ...
    for (int i = 0; i < 1; i++) {
      org.ich.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.ich.keystore.Wallet.generateRandomBytes(512);
