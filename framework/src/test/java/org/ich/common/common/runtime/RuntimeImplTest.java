...
import static org.ich.common.common.runtime.TvmTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.ich.common.common.runtime.TvmTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void getCreatorEnergyLimit2Test() throws ContractValidateException, ContractExeException {
    ...
    Transaction trx = TvmTestUtils.generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
  ...
  public void getCallerAndCreatorEnergyLimit2With0PercentTest()
    ...
    Transaction trx = TvmTestUtils.generateTriggerSmartContractAndGetTransaction(callerAddress, contractAddress,
