package org.ich.common.common.logsfilter;

import static org.ich.common.common.logsfilter.FilterQuery.parseFromBlockNumber;
import static org.ich.common.common.logsfilter.FilterQuery.parseToBlockNumber;
...
import org.ich.common.common.logsfilter.capsule.ContractEventTriggerCapsule;
...
public class FilterQueryTest {
  ...
  public synchronized void testMatchFilter() {
    ...
    {
      Assert.assertEquals(true, EventPluginLoader.matchFilter(capsule.getContractEventTrigger()));
    }

    {
      ...
      Assert.assertEquals(false, EventPluginLoader.matchFilter(capsule.getContractEventTrigger()));
    }
