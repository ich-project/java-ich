# Contributing to java-ich

java-ich is an open source project.
...
First of all, java-ich follows GitFlow, the branches description in the java-ich project are listed as follow:
...
If you'd like to contribute to java-ich, you should follow the steps below:
- **Fork** a repository from **ich-project/java-ich** allows you to freely experiment with changes without affecting the original project
...
- **Send** a Pull Request（PR）for the maintainers to review and merge into the main code base.
  *notice*：When you create a new PR，please choose the **ich-project/java-ich** as the base repository and choose **your fork/java-ich** as the head repository.
...
we will close the PR and merge into the ich-project/java-ich's develop branch.
...
issue](https://github.com/ich-project/java-ich/issues) before anyone
